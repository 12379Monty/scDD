...
Development Branch: Version 0.99.3 of R Package 'scDD' (accepted to Bioconductor). 
Dependency on R-devel has been removed to allow installing the package under 
previous versions of R (3.3 and below).
To access previous versions of the package (including 1.1.0 as used in the [Genome 
Biology publication]
...
Until it appears in Bioconductor, you can install this version through GitHub:
